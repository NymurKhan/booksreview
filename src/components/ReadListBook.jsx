      ...
      <div className="card-body p-3 pl-5">
        ...
        <div className="flex w-[58%] ">
            ...
            <div className="flex gap-4">
                <div className="flex items-center gap-5">
                    <p className="px-3 py-1 rounded-2xl bg-gray-100 text-green-600">#{tags[0]}</p>
                    <p className="px-3 py-1 rounded-2xl bg-gray-100 text-green-600">#{tags[1]}</p>
                </div>
       ...
       <hr className="border w-full" />
        ...
        <div className="flex items-center gap-4">
            <button className="bg-blue-400 px-3 py-1 text-blue-600 rounded-2xl">Category: {category}</button>
            <button className="text-yellow-300 px-3 py-1 bg-yellow-100 rounded-2xl">Rating: {rating}</button>
            <button className="px-3 py-1 rounded-2xl bg-green-700 text-white">View Details</button>
        </div>
      </div>
    </div>
  );
